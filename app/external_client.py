...
async def login_unique(login:str) -> bool:
    """
    Вызывает /LoginUnique и возвращает весь ответ.
    """
    ...
    async with httpx.AsyncClient() as client:
        resp = await client.get(f"{BASE_UTIP_URL}/LoginUnique", params=params, timeout=5)
        resp.raise_for_status()
        return resp.json()
    

# http://edge.webtrader.ink/RegisterUser
